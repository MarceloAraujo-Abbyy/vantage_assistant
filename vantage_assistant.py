...
###  streamlit run C:\Users\marceloraraujo\Documents\vantage_assistant\vantage_assistant\vantage_assistant.py
...
def login_vantage():
    ...
    if username != "" and password != "":
        import requests
        import json
        url = "https://vantage-us.abbyy.com/auth2/"+tenant+"/connect/token"
